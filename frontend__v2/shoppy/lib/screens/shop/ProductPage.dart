...
class _ProductPageState extends State<ProductPage> {
  ...
  void initState() {
    super.initState();
    var currentCartItem = Provider.of<Cart>(context, listen: false)
        .productIsAlreadyInCart(productData!['id']);
    ...
    if (isIncrement) {
      if (_quantity < productData!['available_stock']) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          ...
          content: Text("Maximum count exceeded."),
      ...
      if (_quantity > 0) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          duration: Duration(milliseconds: 1000),
          content: Text("Cant decrement less than zero."),
          backgroundColor: Colors.red,
        ));
      }
    }
            ...
            headerSliverBuilder: (context, innerBoxIsScrolled) => [
                  SliverAppBar(
                    ...
                    flexibleSpace: FlexibleSpaceBar(
                      background: Image(
                        image: NetworkImage(productData!['product_image']),
                        fit: BoxFit.cover,
                      ),
                          ...
                          child: Table(
                            ...
                            children: [
                              ...
                              TableRow(children: [
                                ...
                                Text(
                                  "${productData!['available_stock'] == 0 ? "No" : "Yes"}",
                                  textScaleFactor: 1.2,
                                  textAlign: TextAlign.end,
                                  style: TextStyle(color: Colors.white),
                                )
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                  "Rs. ${productData!['price'] * _quantity} ($_quantity Units)")
            ],
          ),
        ),
      ),
